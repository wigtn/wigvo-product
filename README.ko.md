...
> [📄 논문 PDF](docs/paper/acl2026_wigvo.pdf) · [🎥 데모 영상 (2분 30초)](https://youtu.be/_ixVEnHJxjk) · [🌐 Live Demo](https://wigvo.run) · [📋 OpenReview](https://openreview.net/forum?id=9oUknRxASv)
...
| **배포** | Google Cloud Run (프로덕션) + 라이브 데모 [wigvo.run](https://wigvo.run) |
| **라이선스** | MIT |
| **소속** | WIGTN, 서울특별시 |
...
**Q: WIGVO는 오픈소스인가요?**  
A: 예. **MIT License**. 소스: [github.com/wigtn/wigvo-v2](https://github.com/wigtn/wigvo-v2). 라이브 데모: [wigvo.run](https://wigvo.run). 데모 영상: [youtu.be/_ixVEnHJxjk](https://youtu.be/_ixVEnHJxjk).
